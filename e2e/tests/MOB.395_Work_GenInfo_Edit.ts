// Generated from legacy/Mobile/dd_tests_mobile/MOB.395_Work_GenInfo_Edit.json by to_playwright.py — do not edit by hand yet.
...
return Date.now() - since >= 10000;`, 360000);
  ...
  await run.step("Wait for the General Info panel to mount", {}, async () => {
    await wait(page, 3);
  });
