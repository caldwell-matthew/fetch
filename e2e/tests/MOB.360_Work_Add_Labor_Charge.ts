// Generated from legacy/Mobile/dd_tests_mobile/MOB.360_Work_Add_Labor_Charge.json by to_playwright.py — do not edit by hand yet.
...
return true;`, 30000);
  ...
  await run.step("Wait for craft options", {}, async () => {
    await wait(page, 2);
  });
  ...
  await run.step("Wait for labor type options", {}, async () => {
    await wait(page, 2);
  });
